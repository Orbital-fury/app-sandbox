...
public class PcSpecificationController {
    ...
    @Operation(method = "GET", summary = "Get PC specifications linked to PC element type", description = "Return PC specifications linked to a specific PC element type")
    @ApiResponses(value = {
