...
import com.appsandbox.appsandbox.infrastructure.mmm.rest.requests.Models;
import com.appsandbox.appsandbox.infrastructure.mmm.services.ModelService;
...
public class ModelController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Machine models retrieved successfully")
    })
    @GetMapping()
